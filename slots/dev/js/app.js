...
const slotmachine = new SlotMachine({
    dom: [
        document.getElementsByClassName('superheros-list01')[0], // 必要的动画对象
        document.getElementsByClassName('superheros-list02')[0],
        document.getElementsByClassName('superheros-list03')[0],
    ],
    animate: {
